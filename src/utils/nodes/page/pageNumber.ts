...
import type { NodePos } from "../../../types/node"
 ...
 * @param zeroIndexed - Whether to return the page number as zero-indexed. Default is false.
 * @returns {number} The page number of the resolved position.
 */
export const getPageNumber = (doc: PMNode, $pos: ResolvedPos | number, zeroIndexed = false): number => {
  if (typeof $pos === "number") {
    return getPageNumber(doc, doc.resolve($pos), zeroIndexed)
  }
